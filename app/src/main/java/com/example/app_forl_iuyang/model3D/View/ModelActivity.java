package com.example.app_forl_iuyang.model3D.View;
...
import com.example.app_forl_iuyang.StartActivity;
import com.example.app_forl_iuyang.model3D.demo.ExampleSceneLoader;
import com.example.app_forl_iuyang.model3D.demo.SceneLoader;
...
public class ModelActivity extends Activity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            ...
            Intent resuleIntent=new Intent(ModelActivity.this, StartActivity.class);
